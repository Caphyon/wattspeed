    ...
    <template v-if="requestLimit">
      <div class="quota-exceeded">
        ...
        <svg class="watch" width="200" height="200" viewBox="0 0 185 185" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M174.4 92.2998C174.4 137.3 137.9 173.8 92.8999 173.8C47.8999 173.8 11.3999 137.3 11.3999 92.2998C11.3999 47.2998 47.8999 10.7998 92.8999 10.7998C137.9 10.7998 174.4 47.1998 174.4 92.2998Z" stroke="url(#paint2_linear)" stroke-width="2"/>
          <path d="M92.8999 161.8C131.284 161.8 162.4 130.684 162.4 92.2998C162.4 53.916 131.284 22.7998 92.8999 22.7998C54.5161 22.7998 23.3999 53.916 23.3999 92.2998C23.3999 130.684 54.5161 161.8 92.8999 161.8Z" stroke="url(#paint1_linear)" stroke-width="2"/>
