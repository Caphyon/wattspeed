  ...
  <div>
    <div class="preview-card in-view">
      ...
      <div class="content in-view mt-8">
        <LoadingWrapper
          :loading="loading.performanceMobile"
          class="mt-2 h-16">
    ...
    <div
      ...
      :class="{ loading: loading.performanceMobile }">
        ...
        <div class="flex items-start gap-4">
          <div class="flex-1 space-y-2">
            <div
              ...
              <div>
                <h4
                  v-html="audit.title"
                  class="badge py-2 text-sm font-normal"
          ...
          <div class="flex-1">
            <div class="mobile">
              ...
              <img
                class="mobile-frame h-72"
                src="../assets/icons/mobile-frame.svg"
                alt="mobile frame" />
            </div>
          </div>
        </div>
    ...
    audits() {
      ...
      Object.keys(this.performanceMobile.audits).forEach((auditKey) => {
        if (
          ...
          auditKey === 'font-size' ||
          auditKey === 'plugins' ||
          auditKey === 'content-width'
        ) {
          items.push({
            passed:
              this.performanceMobile.audits[auditKey].score !== null
                ? this.performanceMobile.audits[auditKey].score
                : 0,
